...
import com.yckj.baselib.util.encode.Base64Decoder;
import com.yckj.baselib.util.encode.Base64Encoder;
...
public class AESUtils {
    ...
    private static String ivParameter = "hdksyu28is937zd9";// 密钥默认偏移，可更改
    // private byte[] iv = { 0xA, 1, 0xB, 5, 4, 0xF, 7, 9, 0x17, 3, 1, 6, 8,
    // 0xC,
    // 0xD, 91 };
    private byte[] iv = ivParameter.getBytes();
    private IvParameterSpec IV;
    String sKey = "hjdsosnw8216sl3o";// key必须为16位，可更改为自己的key
    ...
    public AESUtils() {
        ...
        byte[] skAsByteArray;
        try {
            skAsByteArray = sKey.getBytes("UTF-8");
