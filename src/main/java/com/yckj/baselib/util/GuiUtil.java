...
//public static void paddingToItemBottom(RecyclerView recyclerview, View item, View paddingView, int headViewCount){
// recyclerview.scrollToPosition(position + headViewCount));
...
//                paddingView.getLocationOnScreen(ll_location);
//                int dev = ll_location[1] - (location[1] + item.getMeasuredHeight());
//                Log.i("item dev", dev + "");
//                int scrollby = item.getTop() - dev;
//                recyclerview.smoothScrollBy(0, scrollby);
//                Log.i("scroll to ", scrollby + "");
//            }
//        }, 100);
//
//
